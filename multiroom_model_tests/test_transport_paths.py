...
class TestTransportPaths(unittest.TestCase):
    ...
    def test_6_room_example(self):
        windows = [
            Window(self.rooms[1], None, Side.Left),
            Window(self.rooms[1], self.rooms[2], Side.Right),
            Window(self.rooms[2], None, Side.Back),
            Window(self.rooms[2], self.rooms[3], Side.Right),
            Window(self.rooms[2], self.rooms[4], Side.Right),
            Window(self.rooms[3], None, Side.Back),
            Window(self.rooms[3], None, Side.Right),
            Window(self.rooms[4], None, Side.Right),
            Window(self.rooms[4], self.rooms[5], Side.Front),
            Window(self.rooms[5], self.rooms[6], Side.Left),
            Window(self.rooms[6], None, Side.Front)
        ]

        result = paths_through_building(self.rooms, windows)

        a = [r for r in result if Side.Front in r.terminus and Side.Left in r.terminus]
        self.assertEqual(len(a), 1)

        a = [r for r in result if Side.Front in r.terminus and Side.Right in r.terminus]
        self.assertEqual(len(a), 2)

        a = [r for r in result if Side.Front in r.terminus and Side.Back in r.terminus]
        self.assertEqual(len(a), 2)

        a = [r for r in result if Side.Back in r.terminus and Side.Left in r.terminus]
        self.assertEqual(len(a), 2)

        a = [r for r in result if Side.Back in r.terminus and Side.Right in r.terminus]
        self.assertEqual(len(a), 4)

        a = [r for r in result if Side.Left in r.terminus and Side.Right in r.terminus]
        self.assertEqual(len(a), 2)
